...
<div class="container">
    <h1>Create Vac Page</h1>
    <form class="border border-light p-5" action="{{route('storevac')}}" method="POST">
        {{csrf_field()}}
        <p class="text-center h4 mb-4">Add Vaccination Record</p>
        ...
        <div class="input-group mb-3">
          <input type="text" name="age" class="form-control" placeholder="45" aria-label="age"
            aria-describedby="basic-addon2" />
        </div>
        ...
        <div class="input-group mb-3">
            <select class="form-select form-select-lg mb-3" name="brand" aria-label=".form-select-lg example">
              <option value="Pfizer">Pfizer-Biotech (2 shots)</option>
        ...
        <div class="input-group mb-3">
          <button type="submit" class="btn btn-info my-4 btn-block" value="Submit" aria-label="submit"
                  aria-describedby="basic-addon2">Add Vaccination Data</button>
        </div>
    </form>    
</div>
